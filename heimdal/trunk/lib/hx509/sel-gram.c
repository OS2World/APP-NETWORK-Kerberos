...
/*  A Bison parser, made from U:/DEV/heimdal-1.5.3/lib/hx509/sel-gram.y
...
static const char yytranslate[] = {     0,
     ...
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,    12,     2,     2,     2,    17,     2,     2,    13,
    14,     2,     2,    15,     2,    20,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static const short yyprhs[] = {     0,
     0,     2,     4,     6,     9,    13,    17,    21,    23,    25,
    29,    34,    39,    43,    49,    53,    55,    57,    59,    61,
    63,    65,    70,    75,    79
};

static const short yyrhs[] = {    22,
     0,     3,     0,     4,     0,    12,    22,     0,    22,     5,
    22,     0,    22,     6,    22,     0,    13,    22,    14,     0,
    24,     0,    25,     0,    25,    15,    23,     0,    25,    16,
    16,    25,     0,    25,    12,    16,    25,     0,    25,     8,
    25,     0,    25,     7,    13,    23,    14,     0,    25,     7,
    29,     0,    26,     0,    27,     0,    28,     0,    29,     0,
     9,     0,    10,     0,    11,    13,    23,    14,     0,    17,
    18,    30,    19,     0,    11,    20,    30,     0,    11,     0
};
...
static const char * const yytname[] = {   "$","error","$undefined.","kw_TRUE",
"kw_FALSE","kw_AND","kw_OR","kw_IN","kw_TAILMATCH","NUMBER","STRING","IDENTIFIER",
"'!'","'('","')'","','","'='","'%'","'{'","'}'","'.'","start","expr","words",
"comp","word","number","string","function","variable","variables", NULL
};
#endif
...
static const short yydefact[] = {     0,
     2,     3,    20,    21,     0,     0,     0,     0,     1,     8,
     0,    16,    17,    18,    19,     0,     4,     0,     0,     0,
     0,     0,     0,     0,     0,     0,     9,     7,    25,     0,
     5,     6,     0,    15,    13,     0,     0,    22,     0,     0,
    23,     0,    12,    11,    10,    24,    14,     0,     0,     0
};

static const short yydefgoto[] = {    48,
     9,    26,    10,    11,    12,    13,    14,    15,    30
};

static const short yypact[] = {     1,
-32768,-32768,-32768,-32768,    -7,     1,     1,   -10,    25,-32768,
    17,-32768,-32768,-32768,-32768,    27,    25,    21,     8,     1,
     1,    15,    27,     6,    18,    26,    24,-32768,    22,    28,
    25,    25,    27,-32768,-32768,    27,    27,-32768,    27,     8,
-32768,    29,-32768,-32768,-32768,-32768,-32768,    41,    45,-32768
};

static const short yypgoto[] = {-32768,
    -5,   -30,-32768,   -16,-32768,-32768,-32768,    30,     9
};
...
static const short yytable[] = {    27,
    17,    18,    42,     1,     2,    16,    35,    19,    45,     3,
     4,     5,     6,     7,    31,    32,    27,     8,    29,    43,
    44,    36,    27,    22,    23,    20,    21,    33,    24,    20,
    21,     8,    25,    37,    28,     3,     4,     5,    39,    38,
    49,    40,    47,     8,    50,     0,    41,     0,    46,     0,
     0,    34
};

static const short yycheck[] = {    16,
     6,     7,    33,     3,     4,    13,    23,    18,    39,     9,
    10,    11,    12,    13,    20,    21,    33,    17,    11,    36,
    37,    16,    39,     7,     8,     5,     6,    13,    12,     5,
     6,    17,    16,    16,    14,     9,    10,    11,    15,    14,
     0,    20,    14,    17,     0,    -1,    19,    -1,    40,    -1,
    -1,    22
};
